...
window.BINAI_I18N = {
  en: {
    ...
    sub_btn: 'Subscribe — $1/mo LCAI', sub_beta: 'Community beta — unlimited AI for all testers. No payment needed.',
  ...
  zh: {
    ...
    sub_btn: '订阅 — 每月 $1 LCAI', sub_beta: '社区测试版 — 所有测试用户无限 AI，无需付款。',
